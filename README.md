...
- **Live Sessions** — List, get (with the lifecycle state, full transcript, and the live summary's decisions and to-dos), update, and delete chat sessions; read a long transcript page by page.
